...
var AddOption = function (_React$Component6) {
  ...
  function AddOption(props) {
    ...
    _this6.childHandleAddOption = _this6.childHandleAddOption.bind(_this6);
    _this6.state = {
      error: undefined
    };
    return _this6;
  ...
  _createClass(AddOption, [{
    key: "childHandleAddOption",
    value: function childHandleAddOption(e) {
      e.preventDefault();
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          "form",
          { onSubmit: this.childHandleAddOption },
